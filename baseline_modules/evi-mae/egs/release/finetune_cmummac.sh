...
data_train=${dataset_base_path}/cav_label/train_finetune/labels_1574.json
data_val=${dataset_base_path}/cav_label/test_finetune/labels_542.json
label_csv=${dataset_base_path}/cav_label/class_labels_indices.csv
pretrain_path=/path/to/pretrained_ckpt
...
imu_plot_height=128
imu_patch_size=16 
imu_dataset_mean=-70.84
imu_dataset_std=23.44
