...
data_train=${dataset_base_path}/motion_2_priority_test=18/pretrain_cropped_with_flow.json
label_csv=${dataset_base_path}/motion_2_priority_test=18/class_labels_indices.csv
pretrain_path=/home/jaemo/Method/baseline_modules/evi-mae/initial_weight/videomae_adapt_ckpt/video_imu_beforepretrain_model_small_only_encoder.pth
exp_dir=/home/jaemo/Method/checkpoints/evimae/HWU-USP
...
imu_plot_type=stft
imu_channel_num=6 # hwu 6
imu_target_length=128 # need to be 16x, fbank 151->144 for wear; 51->48 for cmu
...
CUDA_VISIBLE_DEVICES=0 CUDA_CACHE_DISABLE=1 python -W ignore /home/jaemo/Method/baseline_modules/evi-mae/src/run_evimae_pretrain.py --model ${model} --dataset ${dataset} \
--data-train ${data_train} --exp-dir $exp_dir \
--label-csv ${label_csv} \
