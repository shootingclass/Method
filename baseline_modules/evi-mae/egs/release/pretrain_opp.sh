...
data_train=${dataset_base_path}/action/pretrain_cropped_with_flow.json
...
exp_dir=/home/jaemo/Method/checkpoints/evimae/Opportunity++
...
CUDA_VISIBLE_DEVICES=0,1,2,3 CUDA_CACHE_DISABLE=1 python -W ignore /home/jaemo/Method/baseline_modules/evi-mae/src/run_evimae_pretrain.py --model ${model} --dataset ${dataset} \
