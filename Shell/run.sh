...
CUDA_VISIBLE_DEVICES=0,1,2,3 python main.py --dataset_name Opportunity++ --batch_size 32 --threshold_epoch 0 --video_classifier_epoch 0 --bad_correction_epoch 0 --momentum_m 0.95  --lambda_hard 2.0 --contrastive_temp 0.07 --damp_warmup_epochs 10
echo "실험 1 완료."
CUDA_VISIBLE_DEVICES=0,1,2,3 python main.py --dataset_name Opportunity++ --batch_size 32 --threshold_epoch 0 --video_classifier_epoch 0 --bad_correction_epoch 0 --momentum_m 0.95  --lambda_hard 2.0 --contrastive_temp 0.07 --damp_warmup_epochs 5
echo "실험 2 완료."
